/****** Object:  Procedure [dbo].[s_user_management]    Committed by VersionSQL https://www.versionsql.com ******/

CREATE PROCEDURE [dbo].[s_user_management] 
...
DECLARE 
	...
	@dt2 varchar(max)=''
	--select @input return;
declare @inputJson varchar(max)=(select cast(decompress(nullif(@input,'')) as varchar(max)));	
